...
<head>
  <title>Mycélium : L'app des Recupérathèques - Catalogue</title>
...
// PWA INSTALL BUTTON
      if (window.matchMedia('(display-mode: standalone)').matches)
      {
          ...
          window.addEventListener("beforeinstallprompt", (e) => {
            promptEvent = e;
            //active le bouton d'installation (désactivé temporairement, faut encore ajouter des tests pour checker si l'app n'est pas déjà installée)
            // button.classList.remove("invisible");
            /*
            button.addEventListener("click", () =>{

              promptEvent.prompt();
              promptEvent.userChoice.then(handlePromptResponse);
