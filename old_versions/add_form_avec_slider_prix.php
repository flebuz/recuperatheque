                ...
                <div id="categorisation" class ="row invisible" >
                 ...
                 <div id="row_tags" class ="row flex-input-field" >
                    ...
                    <div class="col s12 flex-input-field">
                      ...
                      <i id="prefix_tags" class="fas fa-tags prefix"></i>
...
<div class="col s6 m6 input-field"><input type="text" id="rearcameraID" disabled></div></div>
        ...
        <div id="row_poids" class="row input-field">
            ...
            <div class="input-field col s1">
              <p class="no-select left-aligned" >kg</p>
            </div>
            <div class="input-field col s7 m8" id="range_div" >

            <!--  <input type="range" id="slider_slider_poids" min="0.1" max="2.9" value="1.0" step="0.1" name="poids" oninput="set_range_value('indicateur_poids', this.value);" /> -->
              <!--<div id="slider_poids" class="input-field" style="touch-action: none" overflow-scroll="false" onfocus="set_active('', 'prefix_poids')" onblur="set_inactive('prefix_poids')" tabindex="-1" style="outline: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></div>-->
...
<input type="number" name="etat" id="etat" value="1" class="invisible">
          ...
          <div id="row_prix" class="row input-field">
              ...
              <div class="input-field col s5 m3">
                <i id="prefix_prix" class="fas fa-coins prefix"></i>
                <label for="prix">Prix</label>
                <input id="indicateur_prix" name="prix" type="number" value="0" onClick="this.select();" onkeypress="return ValidateNumKeyPress(event);" onfocus="this.oldvalue = this.value;" onchange="ValidateNumber(this);this.oldvalue = this.value; update_slider('slider_prix',this.value, this);" style="text-align: center">
              </div>
              <div class="input-field col s7 m8" id="range_div" >


              <!--  <div id="slider_prix" class="input-field" style="touch-action: none" overflow-scroll="false" style="margin-left:3rem !important;"></div> -->
                <div id="slider_prix" class="input-field" overflow-scroll="false" onfocus="set_active('', 'prefix_prix')" onblur="set_inactive('prefix_prix')" tabindex="-1" style="outline: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></div>
              </div>
...
<script>
    ...
    var slider_prix = document.getElementById('slider_prix');
...
/*
    ...
    slider_prix.noUiSlider.on('update', function( values, handle ) {
       var valeur = slider_prix.noUiSlider.get();
       document.getElementById('indicateur_prix').value= valeur;
       });

       slider_prix.noUiSlider.on('start', function( values, handle ) {
        set_active('','prefix_prix');
          });
       slider_prix.noUiSlider.on('end', function( values, handle ) {
         //set_inactive('prefix_prix');
         slider_prix.focus(); //to keep prefix active until blur
          });
