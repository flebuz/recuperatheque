...
<!-- Désolé, c'est fait super à l'arrache cette partie-ci :p -->
          ...
          <div class="controls" style="position: relative;
              ...
              <div class="row nomargin">
              <label for="file"><i class="material-icons photo-controls">cloud_upload</i></label>
              <input id="file" type="file" accept="image/*" capture style="display:none;"></div>

              <div class="row nomargin">
                <a href="#" id="take-photo" title="Take Photo"><i class="material-icons photo-controls">camera_alt</i></a></div>

<!-- //boutons download et delete
                <div class="row nomargin">
                <a href="#" id="download-photo" download="objet.png" title="Save Photo" class="disabled"><i class="material-icons">file_download</i></a> </div>
                <div class="row nomargin">
...
// solution issue de https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia
  ...
  var take_photo_btn = document.querySelector('#take-photo');
    take_photo_btn.addEventListener("click", function(e){
      ...
      download_photo_btn.href = vignette;
...
<!-- Les onglets avec les catégories de matériaux-->
	<div class="row" style="padding-top: 10px !important; z-index:11;">
