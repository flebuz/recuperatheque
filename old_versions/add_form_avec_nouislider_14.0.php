...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="nouislider/nouislider.css"  media="screen,projection"/>
...
<div id="range_etat" class="input-field" style="touch-action: none" overflow-scroll="false"></div>
...
<!-- Tentative d'émuler en css les tick marks de nouislider mais c'est moche et c'est pas propre-->
...
<input type="range" name="" value="" class="" style="z-index:30;width: 100% !important;  margin-bottom: 5px;" min="1" max="4">
